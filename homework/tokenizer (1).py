...
class2 = open('task2.txt', 'w')
for sentence in sentences:
    class2.write(sentence + '\n')
class2.close()
...
for toksent in row_tok_sents:
    ...
    for word in toksent:
        ...
        i += 1
    tok_sents.append(inxtoksent) #CLASS4.1

class34 = open('task34.txt', 'w')
for token in tok_sents:
    class34.write(json.dumps(token, ensure_ascii=False) + '\n')
class34.close()
